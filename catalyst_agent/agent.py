...
PHONIX_PROJECT_NAME = "default"
register(project_name= PHONIX_PROJECT_NAME, auto_instrument=True)
...
strategy_agent = Agent(
    ...
    model= STABLE_MODEL,
    instruction= """
    ROLE: Calculate forecast growth rate considering past 1-2 year growth rate of the company.
    ...
    """,
    output_key= "future_forecast"
)

# --- Orchestration Layer ---
discovery_agent= ParallelAgent(
    name= 'discovery_agent',
    sub_agents=[profiler_agent, data_agent,strategy_agent]
    
)

# Lead_agent provides summary of all the collected responses.
